...
use crate::{fp_single::FieldParametersSingleWord, impl_word_for};
...
pub(crate) mod tests {
    ...
    #[test]
    fn test_fp32_u32() {
        crate::impl_test_field_parameters!(u32);
    ...
    #[test]
    fn test_fp64_u64() {
        crate::impl_test_field_parameters!(u64);
        all_field_parameters_tests(TestFieldParametersData {
            fp: Box::new(FP64),
