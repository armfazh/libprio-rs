//! Autogenerated: 'fiat-crypto/word_by_word_montgomery' --output fiat_crypto_fp128.rs --lang Rust --inline --inline-internal --no-prefix-fiat --public-function-case snake_case --private-function-case camelCase --public-type-case UpperCamelCase fp128 64 '(2^62-2^3+1)*2^66+1' add sub mul opp from_montgomery to_montgomery to_bytes from_bytes one
//! curve description: fp128
//! machine_wordsize = 64 (from "64")
//! requested operations: add, sub, mul, opp, from_montgomery, to_montgomery, to_bytes, from_bytes, one
...
/// The function fp128_set_one returns the field element one in the Montgomery domain.
///
/// Postconditions:
...
///
#[inline]
pub fn fp128_set_one(out1: &mut Fp128MontgomeryDomainFieldElement) -> () {
